...
$recaptcha_enabled     = $settings['recaptcha_enabled'] ?? false;          // Включена ли reCAPTCHA на сайте
$recaptcha_site_key    = $settings['recaptcha']['site_key'] ?? '';         // Site Key
$recaptcha_secret_key  = $settings['recaptcha']['secret_key'] ?? '';       // Secret Key
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_api_keys'])) {
    ...
    // reCAPTCHA — включение/выключение + ключи
    $settings['recaptcha_enabled'] = isset($_POST['recaptcha_enabled']) ? true : false;

    // Сохраняем ключи только если они введены (не перезаписываем пустыми)
    ...
    // Обновляем переменные после сохранения (чтобы сразу отобразить актуальные значения)
    $tiny_api_key          = $settings['tiny_api_key'] ?? '';
        ...
        <form method="POST" class="card shadow-lg rounded-3 bg-light">
            ...
            <div class="mb-4">
                ...
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Введите ваш API ключ от TinyMCE (<a href="https://www.tiny.cloud/" target="_blank">получить ключ</a>)</small>
                </div>
            </div>

            <!-- Google reCAPTCHA + ВКЛ/ВЫКЛ -->
            <div class="mb-4">
                ...
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Введите Site Key от Google reCAPTCHA</small>
                </div>
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Введите Secret Key от Google reCAPTCHA (<a href="https://www.google.com/recaptcha/admin" target="_blank">получить ключи</a>)</small>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Введите Client ID от Google</small>
                </div>
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Введите Client Secret от Google (<a href="https://console.developers.google.com/" target="_blank">получить ключи</a>)</small>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Введите Bot Token от Telegram (<a href="https://t.me/BotFather" target="_blank">получить токен</a>)</small>
                </div>
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Введите имя бота Telegram (например, @tender_cms_bot)</small>
                </div>
                <div class="mb-3 form-check form-switch">
            ...
            <div class="mb-4">
                ...
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Введите App ID от Facebook</small>
                </div>
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Введите App Secret от Facebook (<a href="https://developers.facebook.com/" target="_blank">получить ключи</a>)</small>
                </div>
            </div>
